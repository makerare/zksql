...
import { parse_type } from '../../aleo/types/index.js';
...
export const retrieve_query_result = async (query_id) => {
    ...
    mapping mintWhitelists:
        key as AddressCollectionMintId;
        value as u64;
    
    mapping collectionMintData:
        key as CollectionMintId;
        value as MintData;
    ...
    finalize create_collection:
        input r0 as CollectionId;
        input r1 as CollectionPublicData;
    ...
    finalize update_collection_public_data:
        ...
        assert_eq r2.publicizable r1.publicizable;
        set r1 into collectionPublicData[r0];
    ...
    function burn_private:
        ...
        assert_eq r1.id.collection_number r0.id.collection_number;
        assert_eq r0.data.updatable true;
    ...
    function burn_public:
        ...
        assert_eq r1.collection_number r0.id.collection_number;
        assert_eq r0.data.updatable true;
        cast r0.owner r0.id r0.data into r2 as Collection.record;
    ...
    function transfer_token_private:
        ...
        input r1 as address.private;
        assert_eq r0.data.transferable true;
    ...
    finalize transfer_token_public:
        ...
        assert_eq r3 r2;
        assert_eq r4.transferable true;
    ...
    finalize remove_token_mint:
        input r0 as IndexCollectionMintId;
        input r1 as u128;
    ...
    finalize update_whitelist:
        input r0 as AddressCollectionMintId;
        input r1 as u64;
    ...
    finalize mint_public:
        ...
        or r25 r26 into r27;
        assert_eq r27 true;
        assert_eq r3 r6.price;
        assert_eq r2 r6.treasury;
    ...
    finalize accept_listing:
        ...
        assert_eq r8.royalty_fees r3;
        assert_eq r8.royalty_address r4;
        remove listings[r1];
        remove publicTokenData[r1];

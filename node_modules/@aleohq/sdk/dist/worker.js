import { AleoKeyProvider, AleoKeyProviderParams, ProgramManager } from './index.js';
import { expose } from 'comlink';
import { initThreadPool, PrivateKey, verifyFunctionExecution } from '@aleohq/wasm';
...
async function executeOffline(localProgram, aleoFunction, inputs, privateKey, proveExecution = false) {
    ...
    try {
        ...
        let response = await programManager.executeOffline(localProgram, aleoFunction, inputs, proveExecution, imports, keyParams, undefined, undefined, PrivateKey.from_string(privateKey));

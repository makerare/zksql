import { Account, AleoNetworkClient, ExecutionResponse, FunctionKeyProvider, KeySearchParams, RecordPlaintext, RecordProvider, RecordSearchParams, PrivateKey, Program, ProgramImports, ProvingKey, VerifyingKey, ProgramManagerBase as WasmProgramManager } from "./index";
/**
...
declare class ProgramManager {
     ...
     * const transaction = await programManager.networkClient.getTransaction(tx_id);
     */
    execute(programName: string, functionName: string, fee: number, privateFee: boolean, inputs: string[], recordSearchParams?: RecordSearchParams, keySearchParams?: KeySearchParams, feeRecord?: string | RecordPlaintext, provingKey?: ProvingKey, verifyingKey?: VerifyingKey, privateKey?: PrivateKey): Promise<string | Error>;
    /**
     ...
     * @returns {Promise<string | Error>}
     */
    join(recordOne: RecordPlaintext | string, recordTwo: RecordPlaintext | string, fee: number, privateFee: boolean, recordSearchParams?: RecordSearchParams | undefined, feeRecord?: RecordPlaintext | string | undefined, privateKey?: PrivateKey): Promise<string | Error>;
    /**
     ...
     * const transaction = await programManager.networkClient.getTransaction(tx_id);
     */
    transfer(amount: number, recipient: string, transferType: string, fee: number, privateFee: boolean, recordSearchParams?: RecordSearchParams, amountRecord?: RecordPlaintext | string, feeRecord?: RecordPlaintext | string, privateKey?: PrivateKey): Promise<string | Error>;
    /**

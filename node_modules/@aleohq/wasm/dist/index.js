...
function __wbg_adapter_34(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures__invoke1_mut__h76225f74e93744a5(arg0, arg1, addHeapObject(arg2));
}
...
function __wbg_adapter_196(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h0edc44cbd56288e2(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
let ProgramManager$1 = class ProgramManager {
    ...
    */
    buildDeploymentTransaction(private_key, program, fee_credits, fee_record, url, cache, imports, fee_proving_key, fee_verifying_key) {
        ...
        const ret = wasm.programmanager_buildDeploymentTransaction(this.__wbg_ptr, ptr0, ptr1, len1, fee_credits, ptr2, ptr3, len3, cache, isLikeNone(imports) ? 0 : addHeapObject(imports), ptr4, ptr5);
        return takeObject(ret);
    }
    /**
    ...
    */
    executeFunctionOffline(private_key, program, _function, inputs, prove_execution, cache, imports, proving_key, verifying_key) {
        ...
        const ret = wasm.programmanager_executeFunctionOffline(this.__wbg_ptr, ptr0, ptr1, len1, ptr2, len2, addHeapObject(inputs), prove_execution, cache, isLikeNone(imports) ? 0 : addHeapObject(imports), ptr3, ptr4);
        return takeObject(ret);
    }
    /**
    ...
    */
    buildExecutionTransaction(private_key, program, _function, inputs, fee_credits, fee_record, url, cache, imports, proving_key, verifying_key, fee_proving_key, fee_verifying_key) {
        ...
        const ret = wasm.programmanager_buildExecutionTransaction(this.__wbg_ptr, ptr0, ptr1, len1, ptr2, len2, addHeapObject(inputs), fee_credits, ptr3, ptr4, len4, cache, isLikeNone(imports) ? 0 : addHeapObject(imports), ptr5, ptr6, ptr7, ptr8);
        return takeObject(ret);
    }
    /**
    ...
    */
    buildJoinTransaction(private_key, record_1, record_2, fee_credits, fee_record, url, cache, join_proving_key, join_verifying_key, fee_proving_key, fee_verifying_key) {
        ...
        const ret = wasm.programmanager_buildJoinTransaction(this.__wbg_ptr, ptr0, ptr1, ptr2, fee_credits, ptr3, ptr4, len4, cache, ptr5, ptr6, ptr7, ptr8);
        return takeObject(ret);
    }
    /**
    ...
    */
    buildSplitTransaction(private_key, split_amount, amount_record, url, cache, split_proving_key, split_verifying_key) {
        ...
        const ret = wasm.programmanager_buildSplitTransaction(this.__wbg_ptr, ptr0, split_amount, ptr1, ptr2, len2, cache, ptr3, ptr4);
        return takeObject(ret);
    }
    /**
    ...
    */
    buildTransferTransaction(private_key, amount_credits, recipient, transfer_type, amount_record, fee_credits, fee_record, url, cache, transfer_proving_key, transfer_verifying_key, fee_proving_key, fee_verifying_key) {
        ...
        const ret = wasm.programmanager_buildTransferTransaction(this.__wbg_ptr, ptr0, amount_credits, ptr1, len1, ptr2, len2, ptr3, fee_credits, ptr4, ptr5, len5, cache, ptr6, ptr7, ptr8, ptr9);
        return takeObject(ret);
    }
    /**
    */
...
export { Address, ExecutionResponse, PrivateKey, PrivateKeyCiphertext, Program, ProgramManager, ProvingKey, RecordCiphertext, RecordPlaintext, Signature, Transaction, VerifyingKey, ViewKey, initThreadPool, verifyFunctionExecution };
